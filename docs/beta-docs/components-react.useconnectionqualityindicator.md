...
[Home](./index.md) &gt; [@livekit/components-react](./components-react.md) &gt; [useConnectionQualityIndicator](./components-react.useconnectionqualityindicator.md)

## useConnectionQualityIndicator (hook)

**Signature:**

```typescript
export declare function useConnectionQualityIndicator(
...
| --------- | -------------------------------------------------------------------------------------------- | ------------ |
| options   | [ConnectionQualityIndicatorOptions](./components-react.connectionqualityindicatoroptions.md) | _(Optional)_ |
