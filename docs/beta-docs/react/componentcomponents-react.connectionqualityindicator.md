...
[Home](./index.md) &gt; [@livekit/components-react](./react/components-react.md) &gt; [ConnectionQualityIndicator](./react/componentcomponents-react.connectionqualityindicator.md)
