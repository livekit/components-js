...
[Home](./index.md) &gt; [@livekit/components-react](./react//components-react.md) &gt; [UseRemoteParticipantsOptions](./react//components-react.useremoteparticipantsoptions.md) &gt; [updateOnlyOn](./react//components-react.useremoteparticipantsoptions.updateonlyon.md)
