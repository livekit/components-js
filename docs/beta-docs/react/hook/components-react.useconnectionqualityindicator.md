...
[Home](./index.md) &gt; [@livekit/components-react](./react//components-react.md) &gt; [useConnectionQualityIndicator](./react/hook/components-react.useconnectionqualityindicator.md)
...
| --------- | --------------------------------------------------------------------------------------------------- | ------------ |
| options   | [ConnectionQualityIndicatorOptions](./react//components-react.connectionqualityindicatoroptions.md) | _(Optional)_ |
