...
import { AudioVisualizerOrb, AudioVisualizerOrbProps } from '@agents-ui';
...
export default {
  ...
  render: ({ hexColor, ...args }: any) => {
    ...
    return (
      <AudioVisualizerOrb
        {...(args as Partial<AudioVisualizerOrbProps>)}
        rgbColor={rgbColor}
        themeMode={themeMode}
...
export const Default: StoryObj<AudioVisualizerOrbProps> = {
  args: {
    blur: 1000,
  },
};
