...
// @public
export function VideoTrack({ onTrackClick, onClick, onSubscriptionStatusChanged, trackRef, name, publication, source, participant: p, ...props }: VideoTrackProps): React_2.JSX.Element;
