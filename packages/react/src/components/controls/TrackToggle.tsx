...
import { useMicrophoneToggle, useToggleButton } from '../../hooks/useTrackToggle';
...
export const MicrophoneToggle = /* @__PURE__ */ React.forwardRef(function MicrophoneToggle(
  ...
  const micToggleState = useMicrophoneToggle(props.onChange);
  const buttonProps = useToggleButton(micToggleState, props.onError);

  return (
    <button ref={ref} {...buttonProps}>
      {getSourceIcon(Track.Source.Microphone, micToggleState.enabled)}
    </button>
  );
});
