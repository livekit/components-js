...
import { ReactShader } from '@/components/agents-ui/react-shader';
import { useAgentAudioVisualizerAuraAnimator } from '@/hooks/agents-ui/use-agent-audio-visualizer-aura';
...
export function AgentAudioVisualizerAura({
  ...
  const { speed, scale, amplitude, frequency, brightness } = useAgentAudioVisualizerAuraAnimator(
    state,
    audioTrack,
  );
