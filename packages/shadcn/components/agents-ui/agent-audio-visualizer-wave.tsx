...
import { useAgentAudioVisualizerWaveAnimator } from '@/hooks/agents-ui/use-agent-audio-visualizer-wave';
...
export function AgentAudioVisualizerWave({
  ...
  const { speed, amplitude, frequency, opacity } = useAgentAudioVisualizerWaveAnimator({
    state,
    audioTrack,
  });
